	...
	<div id="container">
		<div id="header">
			...
			<ul>
				...
				<li>
				<li><a href="<%=request.getContextPath()%>/user?a=updateorm">회원정보수정</a>
				<li>
		...
		<div id="wrapper">
			<div id="content">
				<div id="site-introduction">
					<img id="profile"
						src="<%=request.getContextPath()%>/assets/images/coco1.png">
					<h2>안녕하세요. 송유나의 mysite에 오신 것을 환영합니다.</h2>
					<p>
		...
		<div id="footer">
			<p>(c)opyright 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022,
				2023</p>
		</div>
	</div>
</body>
